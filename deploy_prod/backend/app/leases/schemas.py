...
class LeaseCreate(BaseModel):
    ...
    tenant_id: int = Field(..., validation_alias=AliasChoices("tenant_id","tenantId"))
    unit_id: int = Field(..., validation_alias=AliasChoices("unit_id","unitId"))
    ...
    monthly_rent: float = Field(..., validation_alias=AliasChoices("monthly_rent","monthlyRent","rent"))
    security_deposit: float = Field(0, validation_alias=AliasChoices("security_deposit","securityDeposit","deposit"))
    rent_due_day: int = Field(1, validation_alias=AliasChoices("rent_due_day","rentDueDay"))
